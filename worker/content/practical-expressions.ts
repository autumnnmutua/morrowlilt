...
const library: CompactExpression[][] = [
  ...
  [
    ...
    {
      expression: 'We can move past it.',
      expressionType: 'response',
      partOfSpeech: '回应句；关系修复表达',
      chineseMeanings: [
        '这事可以翻篇了',
        '我们可以继续往前',
        '别让它一直影响关系',
      ...
      coreMeaning:
        'move past 把分歧想象成路上的障碍，表示已经处理过问题，不再让它阻碍后续关系。',
      usageNotes: ['适合误会已经说明或小争执已经处理之后。'],
      first: [
        '友谊赛后',
        '竞争激烈但希望关系照旧。',
        'We both got carried away in that round, but we can move past it.',
        '那局我们都有点上头，不过这事可以翻篇了。',
      ],
      second: [
        '婉拒邀请',
        '对方不能参加时表示理解。',
        "You can't make it tonight? We can move past it and catch up later.",
        '你今晚来不了？没关系，这事翻篇，我们改天再聚。',
      ],
      pitfalls: ['问题尚未解释或补救时就要求“翻篇”，可能显得回避责任。'],
      alternatives: [
        ['Let us put this behind us.', '语气更正式，也更明确地表示结束分歧。'],
      ],
      ieltsUse:
  ...
  [
    ...
    {
      expression: 'Let me know beforehand.',
      expressionType: 'phrase',
      partOfSpeech: '请求句；时间副词表达',
      chineseMeanings: ['提前告诉我一声', '给我提个醒', '事先通知我'],
      coreMeaning:
        'beforehand 直接表示“在事情发生之前”，强调给对方预留准备时间。',
      usageNotes: ['适合日程变化、危险、队友行动前的提醒。'],
      first: [
        '队友配合',
        '希望对方行动前报点。',
        'Let me know beforehand if you plan to push the objective.',
        '你推进目标前先提醒我一声。',
      ],
      second: [
        '行程变化',
        '希望朋友迟到时提前通知。',
        "If you're going to be late, let me know beforehand.",
        '如果你要迟到，提前跟我说一声就好。',
      ],
      pitfalls: ['beforehand 通常放在句末；不要写成 before hand。'],
      alternatives: [
    ...
    {
      expression: 'That adds up.',
      expressionType: 'phrasal_verb',
      partOfSpeech: '短语动词句；逻辑判断',
      chineseMeanings: ['这说得通', '核对得上', '这情况合理'],
      coreMeaning:
        'add up 原指数字相加，这里表示不同线索合在一起能够形成合理解释。',
      usageNotes: ['适合确认解释、数据或事件顺序合理。'],
      first: [
        '复盘信息',
        '队友的时间线与录像吻合。',
        'The cooldown ended at twelve seconds. — That adds up.',
        '冷却在十二秒结束。——这和记录对得上。',
      ],
      second: [
        '朋友解释',
        '迟到原因与交通情况一致。',
        'The trains were delayed? That adds up.',
        '火车晚点了？那就说得通了。',
      ],
      pitfalls: ['That adds up 表示逻辑一致，不代表证据已经经过正式核验。'],
      alternatives: [
  ...
  [
    {
      expression: 'Go with what feels right.',
      expressionType: 'phrase',
      partOfSpeech: '建议句；个人选择表达',
      chineseMeanings: ['选你觉得合适的', '按自己的判断来', '跟着真实感受选择'],
      coreMeaning:
        'go with 表示采纳某个选择；what feels right 强调结合个人感受与判断，而非盲从他人。',
      usageNotes: ['适合没有唯一正确答案、需要个人取舍的轻松建议。'],
      first: [
        '玩法选择',
        '朋友喜欢非主流配置。',
        'Both builds are viable, so go with what feels right.',
        '两套配置都可行，选你觉得顺手的就好。',
      ],
      second: [
        '生活习惯',
        '对方选择与众不同但无害。',
        'Morning and evening both work; go with what feels right.',
        '早晚学习都可以，按适合你的时间来。',
      ],
      pitfalls: [
        '涉及安全、法律或健康风险时不能只凭感觉，应同时考虑可靠信息。',
      ],
      alternatives: [
        [
    ...
    {
      expression: 'That sounds vaguely familiar.',
      expressionType: 'phrase',
      partOfSpeech: '判断句；模糊记忆回应',
      chineseMeanings: ['听着耳熟', '好像有印象', '这让我想起点什么'],
      coreMeaning: 'vaguely 限定熟悉程度，表示记忆被触发但细节仍不完整。',
      usageNotes: ['适合记得一点但无法完全确认的情况。'],
      first: [
        '聊游戏角色',
        '听到名字但记不清细节。',
        'Mira from the old expansion? That sounds vaguely familiar.',
        '旧资料片里的米拉？听着有点耳熟。',
      ],
      second: [
        '线下认人',
        '朋友提到曾见过的人。',
        'The designer we met in Osaka? That sounds vaguely familiar.',
        '我们在大阪见过的设计师？我好像有印象。',
      ],
      pitfalls: ['它不表示已经完全记起；若确定记得，应说 I remember that。'],
      alternatives: [
        ['I vaguely remember that.', '更直接地说明自己只有模糊记忆。'],
      ],
      ieltsUse:
  ...
  [
    ...
    conciseExpression(
      ...
      'response',
      '非正式回应语',
      ['适合你就好', '你觉得可行就行', '按你的方式来'],
      'works 在这里表示某种选择对个人有效或合适，重点是尊重不同做法，而不是评价谁更正确。',
      [
        '风格选择',
        '朋友担心穿搭太特别。',
        'If that jacket feels right, wear it—whatever works for you.',
        '如果那件夹克适合你就穿吧，按你喜欢的来。',
      ],
      [
        '游戏路线',
        '队友想尝试不同打法。',
        'I prefer stealth, but whatever works for you.',
        '我更喜欢潜行，不过适合你的打法就好。',
      ],
      '避免对严肃困境随口使用，否则可能显得敷衍。',
      ['Choose what suits you best.', '更明确，也更适合认真提供建议。'],
    ),
    conciseExpression(
      "We're good.",
      'response',
      '固定回应语',
      ['没事了', '咱们之间没问题', '已经说开了'],
      'good 在这里不是评价表现，而是确认双方关系或当前状况已经恢复正常。',
      [
        '比赛结束',
        '朋友在对局中赢得很彻底。',
        "That match got tense, but we're good.",
        '那局打得有点上头，不过咱们没事。',
      ],
      [
        '拒绝邀请',
        '无法参加朋友组织的活动。',
        'Sorry I snapped earlier. Are we good?',
        '抱歉我刚才语气冲了点，咱们没事吧？',
      ],
      '它不能代替真正需要承担责任的道歉。',
      [
        'I hope we have resolved the misunderstanding.',
        '更正式，适合确认分歧已经解决。',
      ],
    ),
  ],
  [
    conciseExpression(
      ...
      '非正式判断句',
      ['这说得通', '情况对得上', '逻辑没问题'],
      'track 原本表示沿着轨迹跟进；That tracks 表示新信息与已有线索能够连得起来。',
      [
        '核对时间',
        '朋友解释自己为什么迟到。',
        'The last train was delayed? That tracks.',
        '末班车晚点了？那就说得通了。',
      ],
      [
        '游戏机制',
        '数据与测试结果一致。',
        'The bonus only works at night. That tracks.',
        '加成只在夜间生效，数据对得上。',
      ],
      '它表示解释与现有信息一致，不等于已经查证事实百分之百正确。',
  ...
  [
    ...
    conciseExpression(
      ...
      'idiom',
      '祈使句；非正式请求',
      ['有进展告诉我', '让我保持知情', '别把我漏在沟通之外'],
      'loop 指持续的信息循环；keep someone in the loop 强调后续变化也要同步，而不只是提前提醒一次。',
      [
        '计划变化',
        '朋友可能会晚到。',
        'Keep me in the loop if the time changes.',
        '时间有变化就随时同步给我。',
      ],
      [
        '游戏组队',
        '队友准备突然开团。',
        'Keep me in the loop while you plan the next push.',
        '你们计划下一次推进时也让我了解情况。',
      ],
      '不要把 loop 直译成“圈”；这里强调持续纳入沟通。',
      ['Please keep me informed of any updates.', '礼貌且适合正式安排。'],
    ),
    conciseExpression(
  ...
  [
    conciseExpression(
      ...
      'idiom',
      '记忆回应；习语',
      ['你这么一说我想起来了', '经你一提确实如此', '说到这个我有印象了'],
      '表示对方刚提供的线索触发了新的回忆或关联，后面通常接补充信息。',
      [
        '提到名字',
        '朋友说出一位旧同学的名字。',
        'Maya Chen? Now that you mention it, we met at a workshop.',
        'Maya Chen？你这么一说，我想起我们在一次工作坊见过。',
      ],
      [
        '游戏线索',
        '地点名称似乎曾经出现。',
        'Now that you mention it, the Old Harbor appeared in the first quest.',
        '你这么一说，我想起旧港口在第一个任务里出现过。',
      ],
      '它通常需要接着说想起了什么；单独使用可能让对话显得没有说完。',
      ['Your comment reminds me that…', '更完整，适合正式说明被触发的记忆。'],
    ),
    conciseExpression(
